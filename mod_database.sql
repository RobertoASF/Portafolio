...
CREATE TABLE "product_score"(
    ...
    "product_reviewed" INTEGER NOT NULL,
...
ALTER TABLE
    "affinity" ADD PRIMARY KEY("af_id");
...
ALTER TABLE
    "comuna" ADD PRIMARY KEY("comuna_id");
...
ALTER TABLE
    "user_score" ADD PRIMARY KEY("score_id");
...
ALTER TABLE
    "historical" ADD PRIMARY KEY("hist_id");
...
ALTER TABLE
    "provincia" ADD PRIMARY KEY("provincia_id");
...
ALTER TABLE
    "address" ADD PRIMARY KEY("user_id");
...
ALTER TABLE
    "provincia" ADD CONSTRAINT "provincia_region_id_foreign" FOREIGN KEY("region_id") REFERENCES "region"("region_id");
ALTER TABLE
    "product_category" ADD CONSTRAINT "product_category_product_foreign" FOREIGN KEY("product") REFERENCES "category"("cat_id");
ALTER TABLE
    "product_category" ADD CONSTRAINT "product_cat_category_foreign" FOREIGN KEY  ("category") REFERENCES "product" ("prod_id");
ALTER TABLE
    "address" ADD CONSTRAINT "address_comuna_id_foreign" FOREIGN KEY("comuna_id") REFERENCES "comuna"("comuna_id");
ALTER TABLE
    "user_score" ADD CONSTRAINT "user_score_user_reviwer_foreign" FOREIGN KEY("user_reviwer") REFERENCES "user"("user_id");
ALTER TABLE
